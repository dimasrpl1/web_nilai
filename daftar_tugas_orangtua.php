...
<body class="bg-gradient-to-b from-[#1E0342] to-[#433D8B] min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <table class="w-full border-collapse text-sm sm:text-base">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 transition duration-300">
                    ...
                    <td class="p-3 text-center"><?php echo htmlspecialchars($item['tanggal_tugas']); ?></td>
    ...
    <!-- Back Button -->
    <a href="orangtua.php" class="fixed bottom-5 right-5 bg-white text-[#433D8B] font-semibold px-4 py-2 sm:px-5 sm:py-3 rounded-xl shadow-lg hover:bg-[#433D8B] hover:text-white transition duration-300">
        Kembali
    </a>
